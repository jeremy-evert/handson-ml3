# 028_define_minimal_wrapper_scope_state_and_resume_contract__20260417_190057

- run_id: `028_define_minimal_wrapper_scope_state_and_resume_contract__20260417_190057`
- prompt_file: `codex_prompts/028_define_minimal_wrapper_scope_state_and_resume_contract.md`
- prompt_stem: `028_define_minimal_wrapper_scope_state_and_resume_contract`
- started_at_utc: `20260417_190057`

## Execution Facts

- execution_status: `EXECUTED`
- finished_at_utc: `20260417_190237`
...
- elapsed_seconds: `99.296`
- final_output_char_count: `77`
- stderr_char_count: `196171`
...
- profile: (default)
- json: False
- codex_command: codex exec -C /home/jevert/git/handson-ml3 --sandbox workspace-write --output-last-message /tmp/codex-last-message-0mz0q1wd.txt -
...
session id: 019d9cd1-5592-7fc1-b96b-dbb0d7079ba4
--------
user
# Prompt: Define the minimal wrapper scope, state, and resume contract
...
codex
I’m inspecting the existing V1 workflow notes and codex tooling first so the design note stays inside the current repo contract rather than inventing a new control plane.
exec
/bin/bash -lc "sed -n '1,220p' notes/023_tools_codex_assessment__20260417_171721.md" in /home/jevert/git/handson-ml3
exec
/bin/bash -lc "sed -n '1,260p' notes/024_generate_staged_notebook_wrapper_prompts__20260417_172452.md" in /home/jevert/git/handson-ml3
 succeeded in 0ms:
...
codex
I’ve got the contract notes and V1 docs. Next I’m reading the current scripts and notebook-scanner pieces to pin the design note to actual repo behavior rather than just earlier prose.
exec
...
codex
The core behavior is clear now: V1 truth comes entirely from markdown records in `notes/`, and the existing readiness logic keys off latest-per-prompt review status only. I’m checking the remaining script tails just to avoid missing any repo-specific edge conditions before drafting the note.
exec
/bin/bash -lc "sed -n '260,420p' tools/codex/run_prompt.py" in /home/jevert/git/handson-ml3
 succeeded in 0ms:
        "",
        "## Stderr",
        "",
...
exec
/bin/bash -lc "sed -n '260,420p' tools/codex/check_queue_readiness.py" in /home/jevert/git/handson-ml3
 succeeded in 0ms:
...
exec
/bin/bash -lc 'ls notes | tail -n 10' in /home/jevert/git/handson-ml3
 succeeded in 0ms:
...
codex
One more check: I’m reading the already-generated `027` prompt so the new note answers the intended next surface precisely, without drifting beyond the queued design sequence.
exec
/bin/bash -lc "sed -n '1,260p' notes/027_write_028_scope_state_and_resume_contract_prompt__20260417_185855.md" in /home/jevert/git/handson-ml3
 succeeded in 0ms:
...
codex
I’m reading the existing wrapper notes and runner files first so the new prompt stays aligned with the current V1 contract and only covers the next unresolved design surface.
exec
/bin/bash -lc "sed -n '1,220p' notes/023_tools_codex_assessment__20260417_171721.md" in /home/jevert/git/handson-ml3
 succeeded in 0ms:
# 023_tools_codex_assessment__20260417_171721
...
codex
I have enough context. The note will keep the wrapper to a Stage 1 bounded notebook list, make `notes/` the only canonical execution/review truth, and limit wrapper-local state to resume convenience plus a deterministic next-target marker.
exec
...
codex
I’m writing the note now. The contract is intentionally strict on what the wrapper may remember locally so it cannot drift into a second queue or review system.
apply patch
patch: completed
/home/jevert/git/handson-ml3/notes/028_minimal_wrapper_scope_state_and_resume_contract__20260417_190146.md
diff --git a/notes/028_minimal_wrapper_scope_state_and_resume_contract__20260417_190146.md b/notes/028_minimal_wrapper_scope_state_and_resume_contract__20260417_190146.md
new file mode 100644
index 0000000000000000000000000000000000000000..e01d68c4dae0cc5afe4acf616ccaad160f957ced
--- /dev/null
+++ b/notes/028_minimal_wrapper_scope_state_and_resume_contract__20260417_190146.md
@@ -0,0 +1,218 @@
+# Minimal Wrapper Scope, State, and Resume Contract
+
+## Executive Summary
...
codex
The note is in place. I’m doing one quick readback to catch any scope drift against your constraints before I close.
exec
